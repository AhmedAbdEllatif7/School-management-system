...
{use WithFileUploads;
    ...
    public function edit($id)
    {
        ...
        $My_Parent = Parentt::where('id',$id)->first();
        //هنا كإنك بتقول  {{My_Parent->Email$}} = input name = "" value >
        $this->Parent_id = $id;
    ...
    public function submitForm_edit(){
        ...
        if ($this->Parent_id){
            $parent = Parentt::find($this->Parent_id);
            $parent->update([
