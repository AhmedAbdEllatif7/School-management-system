                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('questions.update','test') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">{{trans('Students_trans.quiz_name')}} :<span class="text-danger">{{$question->title}}</span></label>
                                ...
                                <div class="form-row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="Grade_id">{{trans('Students_trans.th_quiz_name')}} : <span
