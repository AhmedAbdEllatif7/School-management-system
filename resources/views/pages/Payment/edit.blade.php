...
@section('content')
    <!-- row -->
    {{trans('Students_trans.payments_student_edit')}} : <label style="color: red">{{$payment_student->student->name}}</label>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <form action="{{route('payments_student.update' , 'test')}}" method="post" autocomplete="off">
                                @method('PUT')
                                @csrf
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>    {{trans('Students_trans.Amount')}} : <label style="color: red">{{$payment_student->student->name}}</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>    {{trans('Students_trans.statement')}} : <label style="color: red">{{$payment_student->student->name}}</label>
                                            : <span class="text-danger">*</span></label>
