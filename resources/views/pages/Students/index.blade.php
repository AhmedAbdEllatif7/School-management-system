                                                ...
                                                <td>
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            ...
                                                            <a class="dropdown-item" href="{{route('students.edit', Crypt::encrypt($student->id)) }}"><i style="color:green" class="fa fa-edit"></i>&nbsp; {{ trans('Students_trans.edit_student_data') }}</a>
                                                            ...
                                                            <a class="dropdown-item" href="{{route('receipt_student.show', $student->id)}}"><i style="color: #9dc8e2" class="fa fa-money"></i>&nbsp; {{ trans('Students_trans.add_receipt') }}</a>
                                                            <a class="dropdown-item" href="{{route('processing_fees.show', $student->id)}}"><i style="color: red" class="fa fa-money"></i>&nbsp; {{ trans('Students_trans.exclude_fee') }}</a>
                                                            <a class="dropdown-item" href="{{route('payments_student.show', $student->id)}}"><i style="color:goldenrod" class="fa fa-money"></i>&nbsp; {{ trans('Students_trans.add_payment') }}</a>
