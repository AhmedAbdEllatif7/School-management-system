                                                                                    ...
                                                                                    <form action="{{ route('sections.update', 'test') }}" method="post">
                                                                                        ...
                                                                                        <div class="col">
                                                                                            ...
                                                                                            <select name = 'status' >
                                                                                                @if($listOfSections->status == 0)
                                                                                                    <option selected disabled>{{trans('Sections_trans.Not active')}}</option>
                                                                                                @else
                                                                                                    <option selected disabled>{{trans('Sections_trans.Active')}}</option>
                                                                                                @endif
                                                                                        ...
                                                                                        <div class="col">
                                                                                            ...
                                                                                            <select multiple name="teacher_id[]" class="form-control" id="exampleFormControlSelect2">
                                                                                                @foreach($listOfSections->teachers as $teacher)
