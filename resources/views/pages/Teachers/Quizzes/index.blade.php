            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('quizzes-teacher.create')}}" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($quizzes as $quizze)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('quizzes-teacher.edit' , $quizze->id)}}"
                                                    ...
                                                    <a href="{{route('quizzes-teacher.show',$quizze->id)}}"
                                            ...
                                            <div class="modal fade" id="delete_exam{{$quizze->id}}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{route('quizzes-teacher.destroy', $quizze->id)}}" method="post">
                                                        {{method_field('delete')}}
                                                        {{csrf_field()}}
