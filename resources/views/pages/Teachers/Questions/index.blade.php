    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    {{ trans('Students_trans.th_quiz_name') }}: <span style="font-size: 20px" class="text-danger">{{$quizz->name}}</span>

                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('questions-teacher.show',$quizz->id)}}" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($questions as $question)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('questions-teacher.edit',$question->id)}}"
